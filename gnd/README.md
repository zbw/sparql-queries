...
[count_wd_by_gnd_class](http://zbw.eu/beta/sparql-lab/?endpoint=http://zbw.eu/beta/sparql/gnd/query&queryRef=https://api.github.com/repos/zbw/sparql-queries/contents/gnd/count_wd_by_gnd_class.rq) | Count Wikidata items linked to GND by GND class
