SPARQL Lab - repository of SPARQL queries
==============
...
Query | Description
------|------------
[count_concept_types](http://zbw.eu/beta/sparql-gui/?endpoint=http://zbw.eu/beta/sparql/stw/query&queryRef=https://api.github.com/repos/jneubert/sparql-queries/contents/stw/count_concept_types.rq) | Count STW concept types (descriptor/thsys) 
[count_descriptors_per_thsys](http://zbw.eu/beta/sparql-gui/?endpoint=http://zbw.eu/beta/sparql/stw/query&queryRef=https://api.github.com/repos/jneubert/sparql-queries/contents/stw/count_descriptors_per_thsys.rq) | Count the descriptors attached to the subthesauri and the second level thsys branches
...
Query | Description
------|------------
[count_mappings_by_target](http://zbw.eu/beta/sparql-gui/?endpoint=http://zbw.eu/beta/sparql/stw/query&queryRef=https://api.github.com/repos/jneubert/sparql-queries/contents/stw/count_mappings_by_target.rq) | Count mappings to STW descriptors to other vocabularies by mapping target
